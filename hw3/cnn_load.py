...
def load_data():
    ...
    #sys.argv[1]
    # n_row = 0    
    # text = open(r'C:\Users\Aidoer\Desktop\Course\Machine Learning\ML2017\hw3\data\train.csv', 'r') 
...
def saving_csv(test):
    ...
    pd.DataFrame(result).to_csv(sys.argv[2], encoding='big5', index=False, header=False);
